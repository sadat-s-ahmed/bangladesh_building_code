...
class PdfviewerT extends StatefulWidget {
  final String url ;
  final String title ;
  PdfviewerT({Key key, this.url , this.title}) : super(key: key);

  _PdfviewerTState createState() => _PdfviewerTState();
}

class _PdfviewerTState extends State<PdfviewerT> {
